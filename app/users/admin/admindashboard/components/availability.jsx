...
const AvailabilityManagement = () => {
  ...
  const fetchavailstatus = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/status/fetch-status.php`
      );
  ...
  const fetchrecurrence = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/recurrence/fetch-recurrence.php`
      );
  ...
  const fetchtimerange = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/timerange/fetch-timerange.php`
      );
  ...
  const fetchavailabilityday = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/availabilityday/fetch-availabilityday.php`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-availability/add-availability.php`,
        {
          ...
          user_id: currentAvailabilityFacultyId,
        }
      );
  ...
  const fetchAvailability = async (userId) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-availability/fetch-availability.php`,
  ...
  const handleEdit = async (availabilityfaculty_id) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-availability/get-availability.php?id=${availabilityfaculty_id}`
      );
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/availableslot/fetch-availableslot.php`,
        {
          params: { availabilityfaculty_id: loggedInUserId },
        }
      );

      const response2 = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-availability/edit-availability.php`,
        {
  ...
  const handleView = async (availabilityfaculty_id) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-availability/view-availability.php?id=${availabilityfaculty_id}`
      );
  ...
  const handleAddSlot = async (availabilityfaculty_id) => {
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-availability/add-slot.php`,
        {
