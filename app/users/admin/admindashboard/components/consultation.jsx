...
const ConsultationManagement = () => {
  ...
  const handleSubmitConsultation = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-consultation/add-consultation.php`,
        payload
      );
  ...
  const fetchConsultation = async (UserID) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-consultation/fetch-consultation.php`,
        { params: { user_id: UserID } }, 
      );
  ...
  const fetchConsultationDetails = async (schedulebookings_id) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-consultation/view-consultation.php`,
  ...
  const handleSubmitConsultationDetails = async () => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-consultation/complete-consultation.php`,
        {
  ...
  const handleSchedule = async (schedulebookings_id, currentStatus) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-consultation/approval-consultation.php`,
        {
          schedulebookings_id,
          action: "Scheduled",
...
const handleFeedback = async (schedulebookings_id) => {
  try {
    const response = await axios.post(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/adminside/admin-consultation/feedback-consultation.php`,
      {
        schedulebookings_id,
        user_id: loggedInUserId,
