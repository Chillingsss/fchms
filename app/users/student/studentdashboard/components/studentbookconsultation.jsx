  ...
  const fetchAvailabilityDataWithNotify = async (isInitial = false) => {
    try {
      const response = await axios.get(
        `
${process.env.NEXT_PUBLIC_API_BASE_URL}/allavailabilityfaculty/fetch-allavailabilityfaculty.php`
      );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `
${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/bookconsultation/add-bookconsultation.php`,
        payload
      );
