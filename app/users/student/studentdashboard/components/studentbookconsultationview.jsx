...
${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/bookconsultation/fetch-bookconsultation.php`,
	...
	const handleCancelled = async (booking_id, currentStatus) => {
		...
		try {
			const response = await axios.post(
				`${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/studentapproval/handle-request.php`,
	...
	const handleEmailView = async (booking_id) => {
		try {
			const response = await axios.get(
				`${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/bookconsultation/view-bookconsultation.php`,
				{ params: { booking_id } }
			);
