...
const SettingsManagement = () => {
  ...
  const fetchStudentsInfo = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/fetch-studentaccount.php`
      );
  ...
  const fetchyearlevel = async () => {
    try {
      const response = await axios.get(
        `
${process.env.NEXT_PUBLIC_API_BASE_URL}/yearlevel/fetch-yearlevel.php`
      );
  ...
  const handleEdit = async (student_id) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/settingsaccount/view-account.php?student_id=${student_id}`
      );
  ...
  const handleStudentUpdateSubmit = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/settingsaccount/edit-account.php`,
        formData,
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/settingsaccount/changepassword.php`,
        {
                ...
                <div className="w-20 h-20 rounded-full overflow-hidden border-2">
                  <img
                    src={
                      editImagePreview
                        ? editImagePreview
                        : `${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/${studentData.photo_url}`
                    }
                    alt="Student Profile"
