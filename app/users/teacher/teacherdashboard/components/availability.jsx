...
const AvailabilityManagement = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await axios.post(
				`${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-availability/add-availability.php`,
				{
	...
	const fetchAvailability = async (userId) => {
		try {
			const response = await axios.get(
				`${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-availability/fetch-availability.php`,
	...
	const handleEdit = async (availabilityfaculty_id) => {
		try {
			const response = await axios.get(
				`${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-availability/get-availability.php?id=${availabilityfaculty_id}`
			);
	...
	const handleUpdate = async (e) => {
		...
		try {
			const response = await axios.post(
				`${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-availability/edit-availability.php`,
				{
	...
	const handleView = async (availabilityfaculty_id) => {
		try {
			const response = await axios.get(
				`${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-availability/view-availability.php?id=${availabilityfaculty_id}`
			);
	...
	const handleAddSlot = async (availabilityfaculty_id) => {
		try {
			...
			const response = await axios.post(
				`${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-availability/add-slot.php`,
				{
			...
			<>
				...
				<div className="bg-white p-6  shadow-md">
					<h1 className="text-l font-bold  text-green-800 pb-5 mt-3 flex items-center gap-2">
						<TbClipboardList className="text-xl w-6 h-6" />
						Availability Slots
					</h1>
