...
const ConsultationManagement = () => {
  ...
  const fetchbookingstudentWithNotify = async (UserID, isInitial = false) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/studentside/bookconsultation/fetch-bookconsultation.php`,
  ...
  const handleSubmitConsultation = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-consultation/add-consultation.php`,
        payload
      );
  ...
  const fetchConsultation = async (UserID) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-consultation/fetch-consultation.php`,
        {
  ...
  const fetchConsultationDetails = async (schedulebookings_id) => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-consultation/view-consultation.php`,
        {
  ...
  const handleSubmitConsultationDetails = async () => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-consultation/complete-consultation.php`,
        {
  ...
  const handleSchedule = async (schedulebookings_id, currentStatus) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-consultation/approval-consultation.php`,
        {
          schedulebookings_id,
          action: "Scheduled",
  ...
  const handleFeedback = async (schedulebookings_id) => {
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/facultyside/teacher-consultation/feedback-consultation.php`,
        {
          schedulebookings_id,
          user_id: loggedInUserId,
      ...
      <>
        ...
        <div className="bg-white p-6  shadow-md">
          ...
          <p className="text-sm text-gray-600 mb-4">
            ...
            including the consultation number, student name, status,
